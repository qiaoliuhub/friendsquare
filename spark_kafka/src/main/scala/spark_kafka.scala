...
//Consume data from kafka "Friendsquare" topic, write checkins information to Cassandra and sink the user_user pair back to kafka. Each user_user pair has one more venue in common.
...
object spark_kafka {
  def main(args: Array[String]) {
   ...
   messages.foreachRDD { rdd =>
      ...
      incommonRDD.map(_.toString).writeToKafka(producerConfig, 
